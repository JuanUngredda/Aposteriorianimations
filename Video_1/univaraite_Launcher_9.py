...
class PointsFromDistribution9(Scene):
    ...
    def construct(self):
        ...
        self.play(Transform(normal_density, multimodal_normal_func_1_density),
                  Transform(vertical_line, vertical_line_2))
        self.wait()
